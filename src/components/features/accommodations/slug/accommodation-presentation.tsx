...
export const AccommodationPresentation = ({
  ...
  return (
    <section className="border-b border-border/60 px-6 py-16 md:px-12 lg:px-20 lg:py-20 xl:px-24">
      <div className="mx-auto grid max-w-420 items-center gap-10 lg:grid-cols-2 lg:gap-16 xl:gap-20">
        ...
        {image ? (
          <div className="relative aspect-4/3 overflow-hidden rounded-sm md:aspect-16/10 md:min-h-80 lg:min-h-88">
            <Image
              src={image.url}
          ...
          <div className="flex aspect-4/3 items-center justify-center rounded-sm bg-card text-sm text-muted-foreground md:aspect-16/10 md:min-h-80 lg:min-h-88">
            Photo à venir
          </div>
        )}
      </div>
