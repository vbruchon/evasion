...
//       {editorPreview && !coverImage ? (
//         <div className="pointer-events-none absolute inset-y-0 right-0 z-10 hidden w-1/2 items-center justify-center px-8 lg:flex">
//           <span className="border border-white/15 bg-black/30 px-4 py-2 text-xs text-white/55 backdrop-blur-sm">
//             {ACCOMMODATION_PREVIEW_PLACEHOLDERS.hero.coverImage}
//           </span>
//         </div>
//       ) : null}
