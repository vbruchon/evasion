...
//   return (
//     <header className="flex shrink-0 items-center justify-between gap-6 border-b border-border/60 px-6 py-4">
...
//           status={status}
//           disabled={isSubmitting}
//           className="px-4 py-2.5 text-sm uppercase tracking-wide"
//           onStatusChange={(nextStatus) =>
//             setValue("status", nextStatus, {
//               shouldDirty: true,
//               shouldValidate: true,
